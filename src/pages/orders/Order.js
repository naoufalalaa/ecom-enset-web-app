...
//get id form url
const URL = `http://localhost:9999/order-service/orders/`
  ...
  return (
    <div className='p-12'>
        <div className='flex flex-wrap -mx-1 lg:-mx-4'>
            <h1 className='text-3xl font-bold mb-6'>ORDER {order.status}</h1>
            <div className='w-full my-1 px-1 lg:my-4 lg:px-4 lg:w-1/2'>
